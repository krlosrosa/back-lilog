...
export interface DevolucaoItensProps {
  id: number;
  sku: string;
  descricao: string;
  lote?: string | null;
...
export class DevolucaoItensEntity {
  private props: DevolucaoItensProps;

  constructor(props: DevolucaoItensProps) {
    this.props = {
      ...props,
  ...
  static fromPrimitives(props: DevolucaoItensProps): DevolucaoItensEntity {
    return new DevolucaoItensEntity(props);
  }
